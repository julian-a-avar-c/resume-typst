...
#work(
  ...
  items: (
    ...
    [Added _Topline CRM_ integration for lead management and customer relationship tracking, capturing data for sales pipeline]
  )
)
...
#skills-table(
  skills-by-categories: (
    ...
    (
      category: "Misc",
      skills: ("MSVC", "GCC", "CMake", "Ninja", "SCons", "Boost", "C++ STL", "DTD", "XSD", "CVS", "SVN", "Pijul", "DSLs", "ZSH", "Fish", "Maven", "Gradle", "NPM", "Yarn", "PNPM", "GraphQL", "Hasura", "Topline CRM", "Linux", "Ubuntu", "OpenSUSE", "NixOS", "Vim", "Matrix", "Godot", "Unity", "Phaser", "Raylib",)
    ),
  )
)
