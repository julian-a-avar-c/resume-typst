...
#work(
  ...
  items: (
    ...
    [Integrated _Stripe_ for payment processing]
  )
)

#work(
  title: "IT, Fullstack & SCADA Developer",
  location: "Brooklyn, NY",
  company: "Processing & Automation Consultancy Solutions",
  dates: dates-helper(start-date: "Jun 2023", end-date: "Present"),
  items: (
    [Developed proprietary SCADA Siemens-integrated real-time analytical engine for real-time data processing and analysis],
    [Integrated _PostHog_ for user data analysis, insights, and user behavior experiments],
    [Integrated _Topline CRM_ providing better data to sales department],
    [Transitioned main website from _WordPress_ to _Astro_, _React_, and _Tailwind_, cutting page load times from 7 seconds to under 1 second],
